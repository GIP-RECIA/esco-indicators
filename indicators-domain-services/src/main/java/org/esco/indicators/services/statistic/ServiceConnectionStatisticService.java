...
public interface ServiceConnectionStatisticService {
    ...
    ///////////////////////////////////////////////////////
    /**
     * Retrieves the number of visitors that made more than <code>treshold</code> connections on the <code>service</code>, and who has one of the specified 
     * <code>usersProfiles</code> in the specified <code>establishmentsUai</code>.<br/>
     ...
     */
    public Integer findWeeklyNumVisitorsAboveTreshold(List<String> establishmentsUai, List<String> services, List<String> usersProfiles, Integer treshold, Integer week, Integer year);
    
    /**
     * Retrieves the number of visitors that made less than <code>treshold</code> connections on the <code>service</code>, and who has one of the specified 
     * <code>usersProfiles</code> in the specified <code>establishmentUai</code>.<br/>
     * This number of visitors only concerns the week having the number <code>week</code> in the year <code>year</code>.
     * 
     * @param establishmentsUai
     ...
     * 	the number 0 if no statistic has been retrieved.
     */
    public Integer findWeeklyNumVisitorsBelowTreshold(List<String> establishmentsUai, List<String> services, List<String> usersProfiles, Integer treshold, Integer week, Integer year);
    
    /**
     * Retrieves the number of visits made on the <code>service</code> for the specified <code>usersProfiles</code> in the specified <code>establishmentUai</code>.<br/>
     ...
     * 	the number 0 if no statistic has been retrieved.
     */
    public Integer findWeeklyNumVisits(List<String> establishmentUai, List<String> services, List<String> usersProfiles, Integer week, Integer year);
     ...
     * 	the number 0 if no statistic has been retrieved.
     */
    public Integer findMonthlyNumVisitorsBelowTreshold(List<String> establishmentsUai, List<String> services, List<String> usersProfiles, Integer treshold, Integer month, Integer year);
     ...
     * 	the number 0 if no statistic has been retrieved.
     */
    public Integer findMonthlyNumVisits(List<String> establishmentsUai, List<String> services, List<String> usersProfiles, Integer month, Integer year);
}
